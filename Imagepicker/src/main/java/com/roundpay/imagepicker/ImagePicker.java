...
import static com.roundpay.image.cropper.CropImage.CAMERA_CAPTURE_PERMISSIONS_REQUEST_CODE;
import static com.roundpay.image.cropper.CropImage.PICK_IMAGE_CHOOSER_REQUEST_CODE;
import static com.roundpay.image.cropper.CropImage.getGalleryIntents;
...
public class ImagePicker implements ImagePickerContract
{
    ...
    private void startImagePickerActivity(boolean includeCamera) {
        ...
        chooserIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP|Intent.FLAG_ACTIVITY_SINGLE_TOP);
        if(fragment!=null){
            fragment.startActivityForResult(chooserIntent, PICK_IMAGE_CHOOSER_REQUEST_CODE);
        }else {
            activity.startActivityForResult(chooserIntent, PICK_IMAGE_CHOOSER_REQUEST_CODE);
        }

...
public class NewBankListScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_bank_list_screen);
        ...
        if (operator != null && operator.size() > 0) {
            ...
            mAdapter = new BankListScreenAdapter(operator, NewBankListScreen.this);

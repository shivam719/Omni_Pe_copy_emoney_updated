...
public class BasicRequest {
    ...
    public BasicRequest(boolean isUPI,String userID, String loginTypeID, String appid, String imei, String regKey, String version, String serialNo, String sessionID, String session) {
        this.isUPI = isUPI;
        this.userID = userID;
        this.sessionID = sessionID;
        this.session = session;

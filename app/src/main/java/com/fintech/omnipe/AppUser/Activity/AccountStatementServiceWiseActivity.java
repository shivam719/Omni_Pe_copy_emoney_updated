...
public class AccountStatementServiceWiseActivity extends AppCompatActivity {
    ...
    private TextView refundStatusChooser, allTab, saleTab, collectionTab;
    ;
    View tabView;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent() != null) {
            ...
            filterFromDate = getIntent().getStringExtra("FromDate");
            filterToDate = getIntent().getStringExtra("ToDate");
        }
    ...
    void findViews() {
        ...
        if ((filterFromDate == null || filterFromDate.length() == 0) || (filterToDate == null || filterToDate.length() == 0)) {

...
public class FOSCollectionReportAdapter extends RecyclerView.Adapter<FOSCollectionReportAdapter.MyViewHolder> {
    ...
    public FOSCollectionReportAdapter(ArrayList<AscReport> transactionsList, CustomLoader loader, LoginResponse loginPrefResponse, Context mContext, FundTransferCallBAck mFundTransferCallBAck) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.adapter_fos_collection_report, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.collectionView.setOnClickListener(v -> {
            ...
            if (mFilterList != null) {
                ...
                /*if(mContext instanceof FosChannelReportActivity){
                    ((FosChannelReportActivity)mContext).collectFund(operator);
                }*/

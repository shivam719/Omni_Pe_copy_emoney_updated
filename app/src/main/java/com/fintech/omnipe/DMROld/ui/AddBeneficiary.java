        ...
        if (v == accVerify) {
            if (validationAddBeneficiary("accVerif") == 0) {
                ...
                if (UtilMethods.INSTANCE.isNetworkAvialable(this)) {
                    ...
                    UtilMethods.INSTANCE.VerifyAccount(this, prefs.getString(ApplicationConstant.INSTANCE.senderNumberPref, ""), ifsc.getText().toString().trim(), accountNumber.getText().toString().trim(), bankName, loader);
        ...
        if (v == create) {
            if (validationAddBeneficiary("") == 0) {
                ...
                if (UtilMethods.INSTANCE.isNetworkAvialable(this)) {
                    ...
                    loader.setCancelable(false);
                    loader.setCanceledOnTouchOutside(false);
                    UtilMethods.INSTANCE.AddBeneficiary(this, prefs.getString(ApplicationConstant.INSTANCE.senderNumberPref, ""), beneficiaryNumber.getText().toString().trim(), beneficiaryName.getText().toString().trim(), ifsc.getText().toString().trim(), accountNumber.getText().toString().trim(), bankName, loader, AddBeneficiary.this);
                } else {
                    UtilMethods.INSTANCE.NetworkError(this, getResources().getString(R.string.network_error_title),
                            getResources().getString(R.string.network_error_message));
                }
...
//            Log.e("Verify"," "+activityFragmentMessage.getMessage());
